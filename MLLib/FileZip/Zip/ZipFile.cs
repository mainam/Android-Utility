...
using MLLib.FileZip.Encryption;
#endif

using MLLib.FileZip.Core;
using MLLib.FileZip.Checksums;
using MLLib.FileZip.Zip.Compression.Streams;
using MLLib.FileZip.Zip.Compression;

namespace MLLib.FileZip.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="MLLib.FileZip.Zip.ZipException">
