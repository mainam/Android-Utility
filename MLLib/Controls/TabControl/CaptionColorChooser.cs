...
{
    partial class ctTabControl
    {
        internal partial class CaptionColorChooser : Form
        {
            #region Instance Members

            public ctTabControl contextInstance;
            ...
            {
                Randomizer = new ctTabControl.RandomizerCaption((byte)nmrRed.Value, (byte)nmrGreen.Value, (byte)nmrBlue.Value, (byte)nmrAlpha.Value,
