...
using MLLib.Win32;
using MLLib.Properties;

namespace MLLib.Controls
{
    [Designer(typeof(KRBTabControlDesigner))]
    public partial class ctTabControl : TabControl
    {
        #region Events
            ...
            if (!DesignMode)
            {
                if (drgevent.KeyState == 1 && drgevent.Data.GetDataPresent(typeof(TabPageEx)))
                {
                    ...
                    if (over != null)
                    {
                        ...
                        int draggingTabIndex = ((ctTabControl)draggingTab.Parent).TabPages.IndexOf(draggingTab);
                ...
                if (drgevent.Data.GetDataPresent(typeof(TabPageEx)))
                {
                    ...
                    if (over != null)
                    {
                        ...
                        if (draggingTab != over)
                        {
                            ...
                            {
                                ((ctTabControl)draggingTab.Parent).TabPages.Remove(draggingTab);
        ...
        class ButtonsCaptionEditor : UITypeEditor
        {
            ...
            public override void PaintValue(PaintValueEventArgs e)
            {
                if (e.Context.Instance is ctTabControl)
                {
                    ctTabControl parent = e.Context.Instance as ctTabControl;
        ...
        class TabpageExCollectionEditor : CollectionEditor
        {
            ...
            protected override void DestroyInstance(object instance)
            {
                ...
                ISelectionService selectionService = (ISelectionService)GetService(typeof(ISelectionService));
                selectionService.SetSelectedComponents(new IComponent[] { (ctTabControl)Context.Instance }, SelectionTypes.Auto);
            }
    ...
    public class KRBTabControlDesigner : System.Windows.Forms.Design.ParentControlDesigner
    {
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                if (_actionLists == null)
                {
                    ...
                    _actionLists.Add(new ctTabControlActionList((ctTabControl)Control));
                }
        ...
        public override DesignerVerbCollection Verbs
        {
            get
            {
                if (_verbs == null)
                {
                    ...
                    ctTabControl parentControl = Control as ctTabControl;
        ...
        protected override void PreFilterProperties(System.Collections.IDictionary properties)
        {
            ...
            properties["Location"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
              (PropertyDescriptor)properties["Location"], BrowsableAttribute.No);
            properties["ShowToolTips"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
            ...
            if (parentControl != null)
            {
                ...
                {
                    properties["ItemSize"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                      (PropertyDescriptor)properties["ItemSize"], BrowsableAttribute.No);
                    properties["TabStyles"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                      (PropertyDescriptor)properties["TabStyles"], BrowsableAttribute.No);
                    properties["Alignments"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                      (PropertyDescriptor)properties["Alignments"], BrowsableAttribute.No);
                    properties["UpDownStyle"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                      (PropertyDescriptor)properties["UpDownStyle"], BrowsableAttribute.No);
                    properties["HeaderStyle"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                      (PropertyDescriptor)properties["HeaderStyle"], BrowsableAttribute.No);
                    properties["TabGradient"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                      (PropertyDescriptor)properties["TabGradient"], BrowsableAttribute.No);
                    properties["IsDrawHeader"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                      (PropertyDescriptor)properties["IsDrawHeader"], BrowsableAttribute.No);
                    properties["CaptionButtons"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                      (PropertyDescriptor)properties["CaptionButtons"], BrowsableAttribute.No);
                    properties["TabBorderColor"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                      (PropertyDescriptor)properties["TabBorderColor"], BrowsableAttribute.No);
                    properties["GradientCaption"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                      (PropertyDescriptor)properties["GradientCaption"], BrowsableAttribute.No);
                    properties["BackgroundColor"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                      (PropertyDescriptor)properties["BackgroundColor"], BrowsableAttribute.No);
                    properties["BackgroundImage"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                      (PropertyDescriptor)properties["BackgroundImage"], BrowsableAttribute.No);
                    properties["BackgroundHatcher"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                      (PropertyDescriptor)properties["BackgroundHatcher"], BrowsableAttribute.No);
                    properties["CaptionRandomizer"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                      (PropertyDescriptor)properties["CaptionRandomizer"], BrowsableAttribute.No);
                    properties["IsDrawTabSeparator"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                ...
                if (parentControl.IsDrawHeader)
                {
                    ...
                    {
                        case ctTabControl.TabHeaderStyle.Hatch:
                            properties["BackgroundColor"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                              (PropertyDescriptor)properties["BackgroundColor"], BrowsableAttribute.No);
                            properties["BackgroundImage"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                              (PropertyDescriptor)properties["BackgroundImage"], BrowsableAttribute.No);
                            break;
                        case ctTabControl.TabHeaderStyle.Solid:
                            properties["BackgroundImage"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                              (PropertyDescriptor)properties["BackgroundImage"], BrowsableAttribute.No);
                            properties["BackgroundHatcher"] = TypeDescriptor.CreateProperty(typeof(ctTabControl),
                              (PropertyDescriptor)properties["BackgroundHatcher"], BrowsableAttribute.No);
        ...
        {
            ctTabControl parentControl = e.Component as ctTabControl;
    ...
    public class ctTabControlActionList : DesignerActionList
    {
        #region Instance Members

        private ctTabControl _linkedControl;
        ...
        public ctTabControlActionList(ctTabControl control)
            : base(control)
        {
        ...
        public ctTabControl.TabStyle TabStyles
        {
        ...
        public ctTabControl.TabAlignments Alignments
        {
        ...
        public Color FirstColor
        {
            ...
            set
            {
                ...
                {
                    ctTabControl.GradientTab oldGradient = _linkedControl.TabGradient;
